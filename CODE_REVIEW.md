...
**Output: `output/numeric_results_quartile_contrasts.csv`** — also the source of Table S2, generated from this CSV by `code/08c2_generate_supp_table_s2_per_iqr.R`.
