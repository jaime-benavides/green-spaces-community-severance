...
# 06_07_run_neighbor_visits_workflow.R
...
prep_cmd <- paste("Rscript", shQuote(paste0(code.folder, "06_prep_neighbor_visits_annual_average.R")))

model_cmd <- paste(
  "Rscript",
  shQuote(paste0(code.folder, "07_models_neighbor_visits_annual_average.R")),
