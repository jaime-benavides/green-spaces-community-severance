...
model_list_ndvi <- list(
  # Global model
  fit_all       = model_gam_mixed_ndvi(dt, by = "none",family_type = "beta"),
  
  # City-level models
  fits_city     = fit_by(dt, by = "city",family_type = "beta", model_fun =  model_gam_mixed_ndvi),
  
  fit_all_crude = model_gam_mixed_ndvi(dt, by = "none",family_type = "beta", include_city = TRUE, crude = TRUE),
  
  # City-level models
  fits_city_crude = fit_by(dt, by = "city",family_type = "beta", crude = TRUE, model_fun =  model_gam_mixed_ndvi),
  
  
  # sens anal no outliers
  fits_outl     = fit_by(dt[which(dt$outlier_flag != "Outlier (|z|>2)"), ], family_type = "beta", by = "none", model_fun =  model_gam_mixed_ndvi),
  fits_outl_city     = fit_by(dt[which(dt$outlier_flag != "Outlier (|z|>2)"), ], by = "city", family_type = "beta", model_fun =  model_gam_mixed_ndvi),
  # ICE quintile (categorical) models
  fits_ice_quint = setNames(
    lapply(ice_quint_vars, function(v)
      fit_by(dt, by = v, model_fun =  model_gam_mixed_ndvi, family_type = "beta", include_city = TRUE)
    ),
    ice_quint_vars
  ),
  ...
  fits_ice_quint_nyc = setNames(
    lapply(ice_quint_vars, function(v)
      fit_by(dt[which(dt$city == "NYC"),], by = v, model_fun =  model_gam_mixed_ndvi, family_type = "beta", include_city = FALSE)
    ),
    ice_quint_vars
  ),
  # ICE quintile (categorical) models
  fits_ice_quint_la = setNames(
    lapply(ice_quint_vars, function(v)
      fit_by(dt[which(dt$city == "LA"),], by = v, model_fun =  model_gam_mixed_ndvi, family_type = "beta", include_city = FALSE)
    ),
    ice_quint_vars
  ),
  ...
  fits_ice_cont = setNames(
    lapply(ice_cont_vars, function(v)
      fit_by(dt, by = "none", model_fun =  model_gam_mixed_ndvi, family_type = "beta", include_city = TRUE, ice_cont = v)
    ),
    ice_cont_vars
  ),
  ...
  fits_ice_cont_no_outl = setNames(
    lapply(ice_cont_vars, function(v)
      fit_by(dt[which(dt$outlier_flag != "Outlier (|z|>2)"), ], by = "none", family_type = "beta", model_fun =  model_gam_mixed_ndvi, include_city = TRUE, ice_cont = v)
    ),
    ice_cont_vars
  ),
...
# generate plots
png(paste0(output.folder, "models_result_", "ndvi_main_beta.png"), 900, 460)
plot_smooth_gam(model_list_ndvi$fit_all, y_limits = c(0, .6), rug = TRUE)
dev.off()
png(paste0(output.folder, "models_result_", "ndvi_crude_beta.png"), 900, 460)
plot_smooth_gam(model_list_ndvi$fit_all_crude, y_limits = c(0, .6), rug = TRUE)
dev.off()
# generate plots
png(paste0(output.folder, "models_result_", "ndvi_ses_outl_beta.png"), 900, 460)
...
png(paste0(output.folder, "models_result_", "ndvi_effect_modif_cities_beta.png"), 900, 460)
patchwork::wrap_plots(plots_city)
dev.off()

plots_city_crude <- plot_smooth_gam(model_list_ndvi$fits_city_crude, y_limits = c(0, .6), rug = T)

png(paste0(output.folder, "models_result_", "ndvi_crude_effect_modif_cities_beta.png"), 900, 460)
...
png(paste0(output.folder, "models_result_", "ndvi_effect_modif_cities_no_outl_beta.png"), 900, 460)
patchwork::wrap_plots(plots_city_no_outl)
dev.off()

plots_ice_quint <- plot_smooth_gam(model_list_ndvi$fits_ice_quint, y_limits = c(0, .6))
png(paste0(output.folder, "models_result_", "ndvi_effect_modif_ice_beta.png"), 900, 460)
...
htmlwidgets::saveWidget(plot_3d_ice_inc, paste0(output.folder, "plot_3d_ice_inc_csi_ndvi_beta.html")) 
...
htmlwidgets::saveWidget(plot_3d_ice_rewb, paste0(output.folder, "plot_3d_ice_rewb_csi_ndvi_beta.html")) 
...
htmlwidgets::saveWidget(plot_3d_ice_inc_no_outl, paste0(output.folder, "plot_3d_ice_inc_csi_ndvi_no_outl_beta.html")) 
...
htmlwidgets::saveWidget(plot_3d_ice_rewb_no_outl, paste0(output.folder, "plot_3d_ice_rewb_csi_ndvi_no_outl_beta.html")) 



plots_city_ice <- plot_smooth_gam(model_list_ndvi$fits_city_ice, y_limits = c(0, .6))
png(paste0(output.folder, "models_result_", "ndvi_effect_modif_city_ice_beta.png"), 900, 460)
patchwork::wrap_plots(plots_city_ice)
dev.off()


png(paste0(output.folder, "models_result_", "q1_q5_ICE_inc_beta.png"), 900, 460)
plot_q1_q5_categorical(model_list_ndvi, ice_var = "ICE_inc_quintile", group = "all")
dev.off()
png(paste0(output.folder, "models_result_", "q1_q5_ICE_rewb_beta.png"), 900, 460)
plot_q1_q5_categorical(model_list_ndvi, ice_var = "ICE_rewb_quintile", group = "all")
dev.off()

png(paste0(output.folder, "models_result_", "q1_q5_ICE_inc_beta_nyc.png"), 900, 460)
plot_q1_q5_categorical(model_list_ndvi, ice_var = "ICE_inc_quintile", group = "nyc")
dev.off()
png(paste0(output.folder, "models_result_", "q1_q5_ICE_rewb_beta_nyc.png"), 900, 460)
plot_q1_q5_categorical(model_list_ndvi, ice_var = "ICE_rewb_quintile", group = "nyc")
dev.off()

png(paste0(output.folder, "models_result_", "q1_q5_ICE_inc_beta_la.png"), 900, 460)
plot_q1_q5_categorical(model_list_ndvi, ice_var = "ICE_inc_quintile", group = "la")
dev.off()
png(paste0(output.folder, "models_result_", "q1_q5_ICE_rewb_beta_la.png"), 900, 460)
...
png(paste0(output.folder, "models_result_", "residuals_main_both_cities_nyc_beta.png"), 900, 460)
...
dev.off()
png(paste0(output.folder, "models_result_", "residuals_main_both_cities_la_beta.png"), 900, 460)
plot_residual_diagnostics(
...
png(paste0(output.folder, "models_result_", "residuals_stratified_nyc_beta.png"), 900, 460)
plot_residual_diagnostics(
...
png(paste0(output.folder, "models_result_", "residuals_stratified_la_beta.png"), 900, 460)
plot_residual_diagnostics(
...
model_list_greenspace <- list(
  # Global model
  fit_all       = model_gam_mixed_greenspace(dt, by = "none",family_type = "gamma"),
  
  # City-level models
  fits_city     = fit_by(dt, by = "city", model_fun = model_gam_mixed_greenspace,family_type = "gamma"),
  
  # Global model
  fit_all_crude       = model_gam_mixed_greenspace(dt, by = "none",family_type = "gamma", , include_city = TRUE, crude = TRUE),
  ...
  # sens anal no outliers
  fits_outl     = fit_by(dt[which(dt$outlier_flag != "Outlier (|z|>2)"), ], by = "none", model_fun = model_gam_mixed_greenspace,family_type = "gamma"),
...
png(paste0(output.folder, "models_result_", "greenspace_close_main_gamma.png"), 900, 460)
plot_smooth_gam(model_list_greenspace$fit_all, y_limits = c(0, 2000), rug = TRUE)
dev.off()

png(paste0(output.folder, "models_result_", "greenspace_dist_ses_outl_gamma.png"), 900, 460)
...
png(paste0(output.folder, "models_result_", "greenspace_close_effect_modif_cities_gamma.png"), 900, 460)
patchwork::wrap_plots(plots_city)
dev.off()


png(paste0(output.folder, "models_result_", "greenspace_close_crude_gamma.png"), 900, 460)
plot_smooth_gam(model_list_greenspace$fit_all_crude, y_limits = c(0, 2500), rug = TRUE)
dev.off()

plots_city_crude <- plot_smooth_gam(model_list_greenspace$fits_city_crude, y_limits = c(0, 2500), rug = T)

png(paste0(output.folder, "models_result_", "greenspace_close_effect_modif_cities_crude_gamma.png"), 900, 460)
patchwork::wrap_plots(plots_city_crude)
dev.off()

plots_city_no_outl <- plot_smooth_gam(model_list_greenspace$fits_outl_city, y_limits = c(0, 2500), rug = T)

png(paste0(output.folder, "models_result_", "greenspace_close_effect_modif_cities_no_outl_gamma.png"), 900, 460)
patchwork::wrap_plots(plots_city_no_outl)
dev.off()

# update
plots_ice_quint <- plot_smooth_gam(model_list_greenspace$fits_ice_quint, y_limits = c(0, 2500))
png(paste0(output.folder, "models_result_", "greenspace_close_effect_modif_ice_gamma.png"), 900, 460)
...
htmlwidgets::saveWidget(plot_3d_green_dist_ice_inc, paste0(output.folder, "plot_3d_ice_inc_csi_green_dist_gamma.html")) 
...
htmlwidgets::saveWidget(plot_3d_green_dist_ice_rewb, paste0(output.folder, "plot_3d_ice_rewb_csi_green_dist_gamma.html")) 
...
htmlwidgets::saveWidget(plot_3d_green_dist_ice_inc_no_outl, paste0(output.folder, "plot_3d_ice_inc_csi_green_dist_no_outl_gamma.html")) 
...
htmlwidgets::saveWidget(plot_3d_green_dist_ice_rewb_no_outl, paste0(output.folder, "plot_3d_ice_rewb_csi_green_dist_no_outl_gamma.html")) 


png(paste0(output.folder, "models_result_", "q1_q5_ICE_inc_green_dist_gamma.png"), 900, 460)
plot_q1_q5_categorical(model_list_greenspace, ice_var = "ICE_inc_quintile", group = "all")
dev.off()
png(paste0(output.folder, "models_result_", "q1_q5_ICE_rewb_green_dist_gamma.png"), 900, 460)
plot_q1_q5_categorical(model_list_greenspace, ice_var = "ICE_rewb_quintile", group = "all")
dev.off()

png(paste0(output.folder, "models_result_", "q1_q5_ICE_inc_green_dist_gamma_nyc.png"), 900, 460)
plot_q1_q5_categorical(model_list_greenspace, ice_var = "ICE_inc_quintile", group = "nyc")
dev.off()
png(paste0(output.folder, "models_result_", "q1_q5_ICE_rewb_green_dist_gamma_nyc.png"), 900, 460)
plot_q1_q5_categorical(model_list_greenspace, ice_var = "ICE_rewb_quintile", group = "nyc")
dev.off()

png(paste0(output.folder, "models_result_", "q1_q5_ICE_inc_green_dist_gamma_la.png"), 900, 460)
plot_q1_q5_categorical(model_list_greenspace, ice_var = "ICE_inc_quintile", group = "la")
dev.off()
png(paste0(output.folder, "models_result_", "q1_q5_ICE_rewb_green_dist_gamma_la.png"), 900, 460)
...
png(paste0(output.folder, "models_result_", "residuals_greenspace_both_cities_nyc_gamma.png"), 900, 460)
plot_residual_diagnostics(
  dt_sf = dt_residuals_sf_nyc_all,
  resid_var = "residual",
  fitted_var = "fitted",
...
dev.off()
png(paste0(output.folder, "models_result_", "residuals_greenspace_both_cities_la_gamma.png"), 900, 460)
plot_residual_diagnostics(
  dt_sf = dt_residuals_sf_la_all,
  resid_var = "residual",
  fitted_var = "fitted",
...
dt_residuals_sf_nyc <- dplyr::left_join(nyc_ses[,"GEOID"], dt_residuals[,c("GEOID","fitted", "residual")])
png(paste0(output.folder, "models_result_", "greenspace_residuals_stratified_nyc_gamma.png"), 900, 460)
plot_residual_diagnostics(
  dt_sf = dt_residuals_sf_nyc,
  resid_var = "residual",
  fitted_var = "fitted",
...
png(paste0(output.folder, "models_result_", "greenspace_residuals_stratified_la_gamma.png"), 900, 460)
plot_residual_diagnostics(
  dt_sf = dt_residuals_sf_la,
  resid_var = "residual",
  fitted_var = "fitted",
