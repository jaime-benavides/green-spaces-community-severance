...
dta_inputs <- readRDS(paste0(generated.data.folder, "community_severance_la_input_data_city.rds"))
...
pcp_outs <- readRDS(file = paste0(generated.data.folder, "pcp_rrmc_", name_sim, "_updated.rds"))
...
saveRDS(dat_scores, paste0(generated.data.folder, "csi_scores_la.rds"))
